...
public class TestHibernate extends BaseTest {
    ...
    {  // Username length 5
        positiveUsername(HibernateStart.username("positive11"));
    }

    @Test

    public void positiveTestCase12() throws Exception {  // Username length 6
        positiveUsername(HibernateStart.username("positive12"));
    } // Username length 6

    @Test

    public void positiveTestCase13() throws Exception {  // Username length 29
        positiveUsername(HibernateStart.username("positive13"));
    } // Username length 29

    @Test

    public void positiveTestCase14() throws Exception {
        positiveUsername(HibernateStart.username("positive14"));
    } // Username length 30
    ...
    {
        homePage.clickCookie();
        homePage.inputEmail(""+ HibernateStart.email("negative221"));
        homePage.inputConfirmationMail(""+ HibernateStart.email("negative221"));
        homePage.inputPassword(HibernateStart.password("negative221"));
        homePage.inputConfirmationPassword(HibernateStart.password("negative221"));
        homePage.checkTermsAndCondition();
        js.executeScript("window.scrollBy(0,400)");
        homePage.checkRobot();
        homePage.clickCreateAnAccount();
        ...
        for (char x : testChars) {
            ...
            homePage.inputUsername(HibernateStart.username("negative222")+ x);
            Assert.assertTrue(homePage.isUserNameTextDisplayed());
    ...
    {
        homePage.clickCookie();
        homePage.inputUsername(HibernateStart.username("negative231") + "o");
        homePage.inputPassword(HibernateStart.password("negative231") + "d");
        homePage.inputConfirmationPassword(HibernateStart.password("negative231") + "d");
        js.executeScript("window.scrollBy(0,500)");
        Thread.sleep(1000);
        homePage.checkTermsAndCondition();
    ...
    {
        homePage.clickCookie();
        homePage.inputUsername(HibernateStart.username("negative241") + "o");
        homePage.inputEmail(HibernateStart.email("negative241"));
        homePage.inputConfirmationMail(HibernateStart.email("negative241"));
        homePage.checkTermsAndCondition();
        homePage.checkNewsletters();
        Thread.sleep(1000);
        ...
        Assert.assertTrue(homePage.isPasswordTextDisplayed());
        Assert.assertEquals("Please enter Password.", homePage.passwordTextGetText());
        homePage.inputPassword(HibernateStart.password("negative242"));
        ...
        homePage.inputPassword(HibernateStart.password("negative243"));
    ...
    {
        homePage.clickCookie();
        homePage.inputUsername(HibernateStart.username("negative31"));
        homePage.inputEmail(HibernateStart.email("negative31"));
        homePage.inputConfirmationMail(HibernateStart.email("negative31"));
        homePage.inputPassword(HibernateStart.password("negative31"));
        homePage.inputConfirmationPassword(HibernateStart.password("negative31"));
        js.executeScript("window.scrollBy(0,500)");
        Thread.sleep(1000);
        homePage.clickCreateAnAccount();
        Assert.assertTrue(homePage.isAcceptTermsTextDisplayed());
    ...
    @Test
        ...
        SessionFactory factory = new Configuration()
                .configure("D:\\Marko\\Moje\\QA\\GitClone\\QA-TraceLabs\\hibernate.cfg.xml")
